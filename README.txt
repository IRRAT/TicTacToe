...
Мы воспринимаем игровое поле как двумерное пространство дискретных точек из натуральных чисел, поэтому будем проверять,
лежат ли n точек на одной прямой, на отрезке длиною  (n-1) либо (n-1) умножить на корень из 2
